...
[![LinkedIn](https://img.shields.io/badge/Connect%20with%20me%20on-LinkedIn-blue.svg)](https://www.linkedin.com/in/muhammad-24b073325/)
[![GitHub](https://img.shields.io/github/stars/AmanPathak-DevOps.svg?style=social)](https://github.com/muhammad21236)
...
Welcome to an immersive DevSecOps Project! This project is about deploying a Tetris game on AWS EKS while mastering the art of DevSecOps.
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/muhammad21236/End-to-End-Kubernetes-DevSecOps-Tetris-Project.git
   ```
